...
sealed interface PropertyDisplayAction {
    data object Get : PropertyDisplayAction
    data object Set : PropertyDisplayAction
}
...
private fun PropertyItem(
    modifier: Modifier,
    item: PropertyVo,
    onAction: (PropertyDisplayAction) -> Unit
) {
    Row(
        modifier.clickable { onAction(PropertyDisplayAction.Get) },
